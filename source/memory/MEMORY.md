...
- 按需读取，默认读取当天创建的文档，追溯超过3天包括3天，文档可能移至项目级 archive/projects/

### 外部引用(references)

<项目根>/.claude/memory/references

- 大模型自己获得的知识来源，我提供的，大模型研究资料，大型文档都可以存放于此，命名格式无要求，大模型的资料存放目录

- 触发方式：按需读取

### 其他

项目级about-me和preferences，读取方式必加载，冲突时优先级高于全局